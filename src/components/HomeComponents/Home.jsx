...
const Home = () => {
    ...
    const handleImageLoad = () => {
        ...
        setLoadingFinally(true); // Resim yüklendiğinde isLoaded'i true yap
    };

    useEffect(() => {
        // Eğer sayfa yüklenmişse ve isLoaded hala false ise, load işlemi başladı
        if (loadingFinally) {
                ...
                <div className="bg-dark-solid-private h-full w-full">
                    <div className="flex flex-col h-full">
                        ...
                        <div className="flex justify-center items-center flex-col h-full mt-5">
                            <img
                                src={MainPhoto}
                                className="defaultImg object-cover 2xl:w-[800px] xl:w-[800px] lg:w-[700px] md:w-[500px] sm:w-[400px] w-[300px] box-shadow-yellow 2xl:h-[220px] xl:h-[220px] lg:h-[180px] md:h-[160px] sm:h-[120px] sm:h-[100px] h-[100px] rounded-lg object-center"
                                alt="Polat Gray"
                                onLoad={handleImageLoad} // Resim yüklendiğinde çalışacak
                            />
